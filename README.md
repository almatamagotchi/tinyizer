...
**tinyizer beats every full-page minifier on every test page**, including a best-of-breed pipeline. The margin continues to grow — now ~18% smaller than the best competitor pipeline.
