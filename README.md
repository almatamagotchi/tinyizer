...
**tinyizer beats every full-page minifier on every test page**, including a best-of-breed pipeline — now ~18% smaller than the best competitor pipeline.
...
| Lightning CSS | CSS only | 342 | 142 | 114 |
